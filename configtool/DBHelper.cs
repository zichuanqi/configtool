...
namespace configtool
{
    ...
    {
        public static void GetConnetString(DataTable dt, string name, out string connectType,out string connectString)
        {
            connectType = "";
            connectString = "";
            ...
            if (drArray.Length > 0)
            {
                ...
                connectType = dr["Type"].ToString().ToLower();
                ...
                {
                    connectString = GetSqlConnetString(server, db, username, pwd);
                }
            }
        }
        ...
        public static string GetSqlConnetString(string server, string db, string username, string pwd)
        {
            string constring = string.Format("Data Source = {0};Initial Catalog = {1};User Id = {2};Password = {3};Integrated Security = True;", server, db, username, pwd);
            return constring;
        }

        public static bool SqlTestConnect(string connectString, out string errMsg)
        {
            errMsg = string.Empty;
            bool flag = false;
        ...
        public static bool SqlTestExtcuteSQL(string connectString, string sql, out string errMsg)
        {
            errMsg = string.Empty;
            bool flag = false;
            try
        ...
        public static int SqlExecuteSQL(string connectString, string sql)
        {
            int ret = 0;
            using (SqlConnection con = new SqlConnection(connectString))
            {
        ...
        public static int SqlExecuteTranSQL(string connectString, string sql)
        {
            int ret = 0;
            using (SqlConnection con = new SqlConnection(connectString))
            {
        ...
        public static DataSet SqlQuery(string connectString, string sql)
        {
            DataSet ds = new DataSet();
            using (SqlConnection con = new SqlConnection(connectString))
            {
